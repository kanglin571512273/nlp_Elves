<template>
  <div class="createContent">
    ...
    <div class="formContainer">
      ...
      <div class="node">
        <span>显示节点个数：</span>
        <span :class="{showNodeNum:true,active:nodeNum == 1} " @click="showNodeNum(1)">100</span>
        <i></i>
        <span :class="{showNodeNum:true,active:nodeNum == 2}" @click="showNodeNum(2)">300</span>
        <i></i>
        <span :class="{showNodeNum:true,active:nodeNum == 3}" @click="showNodeNum(3)">500</span>
        <i></i>
        <span :class="{showNodeNum:true,active:nodeNum == 4}" @click="showNodeNum(4)">1000</span>
      </div>
      <div class="search">
        <el-input placeholder="请输入内容..." v-model="keyword" size="mini" clearable>
          <img v-show="!keyword" src="@/assets/images/search.png" alt slot="suffix" />
        </el-input>
    ...
    <el-dialog :visible.sync="dialogFormVisible">
      <div class="dialogNav">
        <div :class="{navItem:true,active:activeNav == 1}" @click="changeNav(1)">基本属性</div>
        <div :class="{navItem:true,active:activeNav == 2}" @click="changeNav(2)">高级属性</div>
        <div :class="{navItem:true,active:activeNav == 3}" @click="changeNav(3)">规则编辑</div>
      </div>
      <div class="diaContainer">
        ...
        >
          ...
          <el-form-item label="选择颜色：">
            <div class="colorContainer">
              ...
              >
                <i :style="{background:item}" @click="chooseColor(index+1)"></i>
              </div>
            </div>
            <el-color-picker
        ...
        <div class="ruleEditForm scrollbar" v-show="activeNav == 3">
          <div class="ruleItem" v-for="item in ruleEditForm" :key="item.id">
            ...
            <div class="nodeItem">
              <el-input v-model="item.node1" placeholder="请输入" size="mini"></el-input>
            </div>
            <div class="nodeItem">
            ...
            <div class="nodeItem">
              <el-input v-model="item.node4" placeholder="请输入" size="mini"></el-input>
            </div>
            <div class="nodeItem">
